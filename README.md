# DayZCommunityOfflineMode Livonia Edition 1.3
...
# Installation:
Download [this](https://github.com/CypherMediaGIT/DayZCommunityOfflineMode-Livonia-Edition/releases/download/1.3/DayZCommunityOfflineModeLivoniaEdition.zip) zip archive.  
