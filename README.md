...
# Installation:
Download [this](https://github.com/CypherMediaGIT/DayZCommunityOfflineMode-Livonia-Edition/releases/download/1.2/DayZCommunityOfflineMode.Enoch.zip) zip archive.  
